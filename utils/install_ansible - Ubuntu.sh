...
apt-get install -y python-setuptools jq wget git mysql-client
apt-get install -y python-crypto sshpass
apt-get install -y python-pip 
easy_install pip
pip install paramiko PyYAML Jinja2 httplib2 six markupsafe python-dev
pip install pyvmomi
